...
sidebarTitle: "Figma Sites (Pop Up)"
---
...
<Steps>
  ...
  <Step title="Embed the Code in Figma Sites" icon="gear-code">
    ...
    Second, you'll need to take form \<div\> element from Weavely and wrap it in popup logic. For example, if this is your form link: _"https://forms.weavely.ai/8f8b93dd-94cf-4dff-8a21-cccbef407f44"_. Then the following will create a popup which appears after a second on the bottom right of your site:
