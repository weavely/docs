...
<Steps>
  <Step title="Create your Form">
    Figma doesn't have a built-in form builder (yet), so you'll  need to build your form in an external tool in order to add it to your Figma Site. We might be biased here, but we think Weavely is a great tool to build forms 😉 For this tutorial we'll keep things simpel. We built this contact form:
  ...
  <Step title="Add an Embed Layer in Figma">
    Select whichever page you want to add your form to, and drag an _"Embed"_ layer from the tool bar into the page as shown below.
  ...
  <Step title="Set the Embed Source">
