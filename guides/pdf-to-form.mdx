...
3. Leave a simple prompt like:
   ...
   ```
   Generate a research survey using the questions from the attached PDF.
   ```

Weavely will scan the document, extract the questions (including types like multiple choice, rating scales, or open-ended), and generate a fully working form—no manual copy-pasting required.

📸 **Screenshot Suggestion:**  
*The AI Resources panel with the uploaded PDF and the typed prompt visible.*  
**Caption:** “Upload your PDF and prompt the AI to build the form from it.”
...
📸 **Screenshot Suggestion:**  
*Scrolling through the auto-generated form with a question being deleted or edited.*  
...
📸 **Screenshot Suggestion:**  
*Theme tab with a screenshot uploaded and theme preview applied.*  
...
📸 **Screenshot Suggestion:**  
*The email notification setup panel with dynamic fields being added.*  
...
📸 **Screenshot Suggestion:**  
*The field mapping screen with matched questions and sheet columns.*  
...
📸 **Screenshot Suggestion:**  
*The form preview screen with the live shareable URL shown.*  
